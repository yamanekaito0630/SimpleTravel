...
import com.example.simpletravel.form.HouseEditForm;
import com.example.simpletravel.form.HouseRegisterForm;
import com.example.simpletravel.repository.HouseRepository;
import com.example.simpletravel.service.HouseService;
...
public class AdminHouseController {
    ...
    public String index(Model model,
        ...
        if (keyword != null && !keyword.isEmpty()) {
            housePage = this.houseRepository.findByNameLike("%" + keyword + "%", pageable);
        } else {
            housePage = this.houseRepository.findAll(pageable);
        }
